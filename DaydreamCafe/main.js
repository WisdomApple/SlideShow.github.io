...
$(window).load(function () {
    ...
    $('#share .tip').hover(function () {
        ...
        if ($('#' + tipsID).length == 0) {
            ...
            $('#' + tipsID).css({
                top: (pos.top - $('#' + tipsID).height() - 25) + 'px',
                opacity: '0',
                left: (pos.left + ($(this).width() - $('#' + tipsID).width() - 20) / 2) + 'px'
            });
...
function runBg() {
    ...
    if (activePlayer == 'none' && !normalFade)
        $('#bgImageWrapper .new').animate({
            width: $('#bgImageWrapper .new').width() + bW,
            height: $('#bgImageWrapper .new').height() + bH
        }, bgTime + 2000);
...
function pageLoaded() {
    ...
    $('#contentBox .meta-links a').hover(function () {
        ...
        if ($('#' + tipsID).length == 0) {
            ...
            $('#' + tipsID).css({
                top: (pos.top + (($(this).height() - $('#' + tipsID).height()) / 2)) + 'px',
                opacity: '0',
                left: (pos.left - $('#' + tipsID).width() - 30) + 'px'
            });
        }
    ...
    $('#contentBox .tip').hover(function () {
        ...
        if ($('#' + tipsID).length == 0) {
            ...
            $('#' + tipsID).css({
                top: (pos.top - $('#' + tipsID).height() - 30) + 'px',
                opacity: '0',
                left: (pos.left + ($(this).width() - $('#' + tipsID).width() - 20) / 2) + 'px'
            });
            $('#' + tipsID).find('span').css('left', parseInt(($('#' + tipsID).width() - 9 + 20) / 2) + 'px');
...
function setImageAnimations() {
    ...
    $('#contentBox .image_frame a img').each(function () {
        ...
        $(this).parent().parent().find('.hoverWrapperBg').css({
            width: $(this).width() + 'px',
            height: $(this).height() + 'px',
            opacity: '0'
        });
        $(this).parent().parent().find('.hoverWrapper').css({
            width: $(this).width() + 'px',
            height: $(this).height() + 'px'
        });
